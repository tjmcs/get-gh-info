...
var (
	...
	RestrictToTeam bool
	// LookbackTime is used in several subcommands to set the lookback time for the
	// query time window
	LookbackTime string
...
func init() {
	...
	IssuesCmd.PersistentFlags().StringVarP(&LookbackTime, "lookback-time", "l", "", "'lookback' time window (eg. 10d, 3w, 2m, 1q, 1y)")
